...
-- 4. Verificar detalhes do perfil (CORRIGIDO)
SELECT 
    '4. DETALHES DO PERFIL:' as etapa,
    p.id,
    u.email, -- Pegando email da tabela auth.users
    p.nome,
    p.role,
    p.ativo,
...
-- 9. VERIFICAR ESTRUTURA DA TABELA PROFILES (para debug)
SELECT 
    '9. ESTRUTURA PROFILES:' as etapa,
    column_name,
    data_type,
    is_nullable
