-- SCRIPT ADMIN QUE VAI FUNCIONAR
...
-- 3. Limpar TODOS os dados existentes do usuário admin (ordem correta)
...
-- 7. Inserir na tabela profiles com valor padrão correto para status_disponibilidade
INSERT INTO profiles (id, role, status_disponibilidade, created_at, updated_at)
SELECT 
    au.id, 
    'admin', 
    'disponivel_sistema', -- usando o valor padrão que vimos na estrutura
    NOW(), 
    NOW()
FROM auth.users au 
