-- SCRIPT FINAL CORRIGIDO PARA MATUTARIA
...
BEGIN
    ...
    SELECT 
        ...
        'restaurante',
        'aprovada',
        '{"rua": "Rua Principal", "numero": "123", "bairro": "Centro", "cidade": "Sobral", "cep": "62000-000", "estado": "CE"}',
        '{"telefone": "(85) 99999-9999", "email": "matutaria@gmail.com"}',
        NOW(),
        NOW()
    WHERE NOT EXISTS (
