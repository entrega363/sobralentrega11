-- SCRIPT FUNCIONAL PARA CRIAR ADMIN
...
DELETE FROM profiles WHERE email = 'entregasobral@gmail.com';
...
-- 7. Inserir na tabela profiles (assumindo que tem as colunas básicas)
...
SELECT 'PROFILE_CRIADO' as status, * FROM profiles WHERE email = 'entregasobral@gmail.com';