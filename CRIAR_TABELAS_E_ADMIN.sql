-- SCRIPT COMPLETO: CRIAR TABELAS E USUÁRIO ADMIN
...
-- 7. Criar view profiles se não existir
...
SELECT 'TESTE_PROFILES' as teste, * FROM profiles WHERE email = 'entregasobral@gmail.com';