-- ========================================
-- SCRIPT FINAL - USUÁRIOS DE TESTE
-- ========================================
...
INSERT INTO auth.users (
    ...
    'authenticated', 'authenticated', 'teste.consumidor@gmail.com',
    crypt('123456', gen_salt('bf')), NOW(),
    '{"provider": "email", "providers": ["email"]}',
    '{"role": "consumidor"}', NOW(), NOW(), '', '', '', ''
);

INSERT INTO profiles (id, role) VALUES (
    'c1111111-1111-1111-1111-111111111111', 'consumidor'
);

INSERT INTO consumidores (id, profile_id, nome, telefone, endereco, status) VALUES (
    'c1111111-2222-3333-4444-555555555555',
    'c1111111-1111-1111-1111-111111111111',
    'João Silva (Teste)', '(88) 91111-1111',
...
INSERT INTO auth.users (
    ...
    'authenticated', 'authenticated', 'teste.empresa@gmail.com',
    crypt('123456', gen_salt('bf')), NOW(),
    '{"provider": "email", "providers": ["email"]}',
    '{"role": "empresa"}', NOW(), NOW(), '', '', '', ''
);

INSERT INTO profiles (id, role) VALUES (
    'e2222222-2222-2222-2222-222222222222', 'empresa'
);
...
INSERT INTO empresas (id, profile_id, nome, cnpj, categoria, status, endereco, contato) VALUES (
    ...
    'e2222222-2222-2222-2222-222222222222',
    'Restaurante Teste Ltda', '11222333000144', 'Alimentação', 'aprovada',
...
INSERT INTO auth.users (
    ...
    'authenticated', 'authenticated', 'teste.entregador@gmail.com',
    crypt('123456', gen_salt('bf')), NOW(),
    '{"provider": "email", "providers": ["email"]}',
    '{"role": "entregador"}', NOW(), NOW(), '', '', '', ''
);

INSERT INTO profiles (id, role) VALUES (
    'd3333333-3333-3333-3333-333333333333', 'entregador'
);

INSERT INTO entregadores (id, profile_id, nome, telefone, veiculo, status, disponivel) VALUES (
    'd3333333-4444-5555-6666-777777777777',
    'd3333333-3333-3333-3333-333333333333',
    'Carlos Santos (Teste)', '(88) 93333-3333',
