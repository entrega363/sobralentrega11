-- SCRIPT FINAL SIMPLES PARA CRIAR ADMIN
...
-- 7. Criar view profiles SIMPLES (só para admin por enquanto)
...
-- 11. Testar a view profiles
SELECT 'PROFILE_FUNCIONANDO' as teste, * FROM profiles WHERE email = 'entregasobral@gmail.com';